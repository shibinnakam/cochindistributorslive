...
module.exports = (io) => {
  ...
  router.get("/admin/generate-report", authMiddleware, adminMiddleware, async (req, res) => {
    try {
      ...
      doc.text("Units", 280, tableTop, { width: 50, align: "right" });
      doc.text("Revenue", 350, tableTop, { width: 80, align: "right" });
      doc.text("Profit", 450, tableTop, { width: 80, align: "right" });

      doc.moveTo(50, tableTop + 15).lineTo(530, tableTop + 15).strokeColor("#dddddd").stroke();
      doc.font("Helvetica");
